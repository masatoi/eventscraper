...
class DataExporter:
    ...
    @staticmethod
    def export_to_json(results: List[ScrapingResult], output_path: Union[str, Path]) -> bool:
        """JSONファイルにエクスポート"""
        try:
                ...
                for article in result.articles:
                    article_data = {
                        ...
                        'author': {
                            ...
                            'profile_url': str(article.author.profile_url) if article.author.profile_url else None,
    ...
    @staticmethod
    def export_to_csv(results: List[ScrapingResult], output_path: Union[str, Path]) -> bool:
        """CSVファイルにエクスポート"""
        try:
            output_path = Path(output_path)
            ...
            for result in results:
                for article in result.articles:
                    article_row = {
                        ...
                        'author_profile_url': str(article.author.profile_url) if article.author.profile_url else '',
    ...
    @staticmethod
    def export_summary(results: List[ScrapingResult], output_path: Union[str, Path]) -> bool:
