...
class ScraperManager:
    ...
    async def scrape_multiple_sites(self, sites: List[str], limit: int = 30) -> List[ScrapingResult]:
        """複数サイトを並行スクレイピング"""
        ...
        logger.info(f"Scraping completed. Total articles: {total_articles}, Total errors: {total_errors}")
